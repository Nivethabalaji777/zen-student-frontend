        ...
        <h6 className='apiCallError-h6-class'>{apiCallError}</h6>
                ...
                <p className='actvities-p'>Webcode-1</p>
                        <div>
                            ...
                            <div>
                                <Input placeholder="Enter valid link of webcode-1 source code" type='text' disabled={true} value={webcode_1_SubmittedLink}/>
                            ...
                            <div>
                                <Input placeholder="Enter valid link of webcode-1 source code" type='text' value={webcode_1_FormData.link} onChange={handleWebcodeFormChange_1}/>
                                <span>{webcode_1_FormErrors}</span>
                                <br />
                                <div className='task-submission-button-div'><Button className='task-submission-button' color='success' onClick={handlewebcodeFormSubmit_1} disabled={disableSubmit_1}>Submit</Button></div>
                            </div>
                        }
                        </div>                  
                </div>
                ...
                <p className='actvities-p'>Webcode-2</p>
                        ...
                        <div>
                            ...
                            // Displaying the submitted link and date
                            <div>
                                <Input placeholder="Enter valid link of webcode-2 source code" type='text' disabled={true} value={webcode_2_SubmittedLink}/>
                                <div className='task-submission-button-div'><Button className='task-submission-button' color='success' disabled={true}>Submit</Button></div>
                            ...
                            // Displaying the field for submission
                            <div>
                                <Input placeholder="Enter valid link of webcode-2 source code" type='text' value={webcode_2_FormData.link} onChange={handleWebcodeFormChange_2}/>
                                <span>{webcode_2_FormErrors}</span>
                                <br />
                                <div className='task-submission-button-div'><Button className='task-submission-button' color='success' onClick={handlewebcodeFormSubmit_2} disabled={disableSubmit_2}>Submit</Button></div>
                            </div>
                        }
                        </div>                  
                </div>
